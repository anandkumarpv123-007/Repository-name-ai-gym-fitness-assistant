...
Comprehensive, beginner-friendly learning guide for Developer 3 (Anand).
...
def build_docx():
    ...
    add_callout(
        doc,
        "Authoritative Learning Guide for Developer 3 (Anand). Covers all 40 system architecture, "
